...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UComponenteMovimiento_Statics::NewProp_MovimientoComun_MetaData[] = {
		{ "ModuleRelativePath", "ComponenteMovimiento.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UComponenteMovimiento_Statics::NewProp_MovimientoComun = { "MovimientoComun", nullptr, (EPropertyFlags)0x0010000000000000, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UComponenteMovimiento, MovimientoComun), METADATA_PARAMS(Z_Construct_UClass_UComponenteMovimiento_Statics::NewProp_MovimientoComun_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UComponenteMovimiento_Statics::NewProp_MovimientoComun_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UComponenteMovimiento_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UComponenteMovimiento_Statics::NewProp_MovimientoComun,
	};
	...
	IMPLEMENT_CLASS(UComponenteMovimiento, 3544892626);
