...
UCLASS()
class GALAGA_USFX_L01_API AVidaNave : public AActor, public INavesBuilder
{
	GENERATED_BODY()
...
public:	
	...
	class UStaticMesh* VidaNave = LoadObject<UStaticMesh>(nullptr, TEXT("StaticMesh'/Game/Geometry/Meshes/1M_Cube.1M_Cube'"));
